...
| Version | Changes |
| :--- | :--- |
| **Version 1.0.0-beta1** | **FEATURES**<br>- **Infrastructure:** Added the Infrastructure tool to add and edit points of interest (icons) and routes (lines).<br><br>**IMPROVEMENTS**<br>- Prevent vector features being added outside the map boundary. |
